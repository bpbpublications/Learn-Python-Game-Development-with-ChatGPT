...
st.image("images/splash.png", caption="Your Caption", use_column_width=True)
...
with st.form(key='chat_form'):
    user_input = st.text_input("Type your message:", key=f'input_key_{st.session_state.input_version}')
